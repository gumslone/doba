...
@php
    ...
    $sections = [
        __('admin.group_today') => [
            ...
            // Badges are for what is waiting on a person: unread mail, dirty doors.
            ['/admin/enquiries', __('admin.enquiries'), 'admin/enquiries*', \App\Models\Enquiry::unreadCount()],
            ['/admin/rooms', __('admin.rooms'), 'admin/rooms*'],
            ['/admin/housekeeping', __('admin.housekeeping'), 'admin/housekeeping*', \App\Http\Controllers\Admin\AdminHousekeepingController::dirtyCount()],
