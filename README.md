...
> The correctness-critical paths are covered by 170+ tests on both database
...
| [![Checkout](docs/screenshots/booking-checkout.png)](docs/screenshots/booking-checkout.png)<br>**Checkout** — guest details, extras, consent, live summary | |
