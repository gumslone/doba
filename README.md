...
**[gumslone.github.io/doba](https://gumslone.github.io/doba/)** — the short version for hoteliers, with a commission calculator · [Deutsch](https://gumslone.github.io/doba/de/)
...
| [![Front desk](docs/screenshots/admin-front-desk.png)](docs/screenshots/admin-front-desk.png)<br>**Front desk** — arrivals with stated times, in house, leaving, checked out | [![Apartment](docs/screenshots/apartment.png)](docs/screenshots/apartment.png)<br>**Apartment** — bedrooms, minimum stay, cleaning fee per stay, `Apartment` schema |
| [![Availability](docs/screenshots/admin-availability.png)](docs/screenshots/admin-availability.png)<br>**Availability grid** — allotment, prices and restrictions per night | [![Reports](docs/screenshots/admin-reports.png)](docs/screenshots/admin-reports.png)<br>**Reports** — occupancy, ADR, RevPAR, channel mix, pace |
